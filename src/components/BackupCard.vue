    ...
    <div class="backup-card-content">
      ...
      <div class="description">
        <span>
          ...
          </svg>Last backup {{ dayjs().calendar(dayjs(backup.Metadata.LastBackupDate)) }} <span class="fw-semibold">yesterday</span> at <span class="fw-semibold">11:36 PM</span>
        </span>
      </div>
      <div class="description d-flex align-items-center">
        <!-- <span> -->
          ...
          <span><span class="fw-semibold">416 MB</span> stored</span>
        <!-- </span> -->
        ...
        <!-- <span style="margin-left: 1rem;"> -->
          ...
          <span><span class="fw-semibold">149 MB</span> source</span>
        <!-- </span> -->
      </div>
    </div>
...
console.log(dayjs(props.backup.Metadata.LastBackupDate))
